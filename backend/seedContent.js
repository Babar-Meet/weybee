...
async function seedContent() {
  const pages = [
    {
      ...
      sections: [
          ...
          items: [
            {
              ...
              description:
                "Leverage our expertise to build efficient, future-ready systems that scale with your business.",
              image: "/assets/WeyBee-IT-Staff-Augmentation.webp",
              link: "/it-staff-augmentation",
            },
            {
              title: "Software Development Services",
              description:
                "Custom software solutions designed to drive growth and streamline operations.",
              image: "/assets/WeyBee-Software-Development.webp",
              link: "/software-development-services",
            },
            {
              title: "IT Services for Startups",
              description:
                "End-to-end MVP development and tech support tailored for startups.",
              image: "/assets/WeyBee-IT-Services-Startups.webp",
              link: "/it-services-for-startups",
            },
            {
              title: "Data Engineering",
              description:
                "Data scraping, AI-ML Engineering and smart technology solutions.",
              image: "/assets/DataEngineering-Weybee-Services-1.webp",
        ...
        },
        {
          ...
          items: [
            {
              title: "Dedicated Vetted Developers",
              description:
                "Our experienced developers ensure exceptional results for your projects.",
              icon: "🎓",
            },
            {
              title: "Transparent Operations",
              description:
                "We maintain open communication, keeping you informed throughout the process.",
              icon: "🔍",
            },
            {
              title: "Diverse Expertise",
              description:
                "Our team specializes in IT staff augmentation, software development, digital marketing, and data engineering.",
              icon: "🧩",
            },
            {
              title: "Long-Term Partnership",
              description:
                "Average partnership of 3.5 years – we grow alongside your business.",
              icon: "🤝",
            },
            {
              title: "Client Satisfaction",
              description:
                "95% client satisfaction rate – delivering what we promise, consistently.",
              icon: "😊",
            },
            {
              title: "Proven Growth",
              description:
                "30% average profitability increase for our clients through optimized technology.",
              icon: "📈",
            },
            {
              title: "Innovative Approach",
              description:
                "We stay ahead of trends, integrating the latest tech to keep you competitive.",
              icon: "💡",
            },
            {
              title: "Expert vetted Skilled Talent",
              description:
                "Access a deep pool of certified professionals across all technology stacks.",
              icon: "👨‍💻",
            },
            {
              title: "Strategic Partnership",
              description:
                "We align with your business goals to deliver maximum ROI and strategic value.",
              icon: "🎯",
            },
          ],
        },
        {
          ...
          order: 5,
          bgColor: "#f4f6fa",
          heading: "Flexible Business",
          subheading: "Engagement Models",
          items: [
            {
              title: "Dedicated Team Model",
              description:
                "Integrate our offshore team members as a seamless extension of your in-house staff.",
              image: "/assets/WeyBee-Dedicated-Team-Model.jpg",
            },
            {
              title: "Pay as you Go Model",
              description:
                "Get flexibility to scale up or down as needed, paying only for the hours worked.",
              image: "/assets/WeyBee-Pay-as-you-Go-Model.jpg",
            },
            {
              title: "Fixed Price Model",
              description:
                "Predictable costs and timelines—ideal for well-defined projects with clear deliverables.",
              image: "/assets/WeyBee-Fixed-Price-Model.jpg",
            },
          ],
        },
        {
          ...
          items: [
            ...
            {
              title: "Angular",
              image: "/assets/WeyBee-Technology-Angular.jpg",
            },
            ...
            {
              title: ".NET Core",
              image: "/assets/WeyBee-Technology-NET-Core.jpg",
            },
            { title: "IOT", image: "/assets/WeyBee-Technology-IOT.jpg" },
            {
              title: "Laravel",
              image: "/assets/WeyBee-Technology-Laravel.jpg",
            },
          ...
          items: [
            {
              title: "W - Work",
              description:
                "Culture of Excellence. Foster Creativity, Teamwork & Innovation for Outstanding Results.",
            },
            {
              title: "E - Educate",
              description:
                "Continuous Learning to Empower Both the Team and Clients in the Fast-Paced IT Industry.",
            },
            {
              title: "Y - You-Focused",
              description:
                "Centered on understanding and Delivering Personalised Solution for Clients, Employees, and Partners.",
            },
            {
              title: "B - Betterment",
              description:
                "Focus on improvement through every project and interaction to create a better future.",
            },
            {
              title: "E - Efforts",
              description:
                "Dedication and hard work drive long-lasting success.",
            },
            {
              title: "E - Ethics",
              description:
                "Uphold integrity, transparency, and fairness in every partnership.",
            },
          ],
        },
      ],
    },
    {
      ...
      isPublished: true,
      metaDescription:
        "Contact WeyBee for IT solutions and technology partnerships",
      sections: [
        {
          sectionId: "hero",
          order: 0,
        ...
        },
        {
          ...
          groups: [
            {
              country: "India Offices",
              flag: "🇮🇳",
              phone: "+91 88660 08860",
              locations: [
                {
                  title: "Rajkot Office",
                  description:
                    "303, Nakshatra Heights, 150 Feet Ring Road, Opp. Raiya Telephone Exchange, Besides Water Tank, Rajkot, Gujarat 360005.",
                },
                {
                  title: "Ahmedabad Office",
                  description:
                    "1012, Aaron Spectra, Rajpath Rangoli Rd, behind Rajpath club, Bodakdev, Ahmedabad, Gujarat 380059",
                },
              ],
            },
            {
              ...
              flag: "🇦🇺",
              phone: "+61 2 8024 5936",
              locations: [
                {
                  title: "Sydney Office",
                  description:
                    "WOTSO Pyrmont, 3/55 Pyrmont Bridge Rd, Pyrmont NSW 2009, Australia",
                },
              ],
            },
            {
          ...
          items: [
            {
              title: "Fun",
              description:
                "We never miss a chance to come together and Celebrate. We celebrate Indian/Global Events & Festivals, organize Team Lunch, Outings, and play challenging indoor-games.",
              icon: "🎉",
            },
            {
              title: "Learn",
              description:
                "Our business growth inevitably gives opportunities to learn. Training Program, External Courses, LLM (Learn – Leverage – Master) to fast-track learning.",
              icon: "📚",
            },
            {
              title: "Growth",
              description:
                "We take responsibility of individual growth. We chart Career Growth for each achiever, coach life skills to navigate better in personal life.",
              icon: "🚀",
            },
          ],
        },
    ...
    },
    {
      ...
      isPublished: true,
      metaDescription:
        "Explore WeyBee Services - IT Staff Augmentation, Software Development, Data Engineering, and Startups IT Services",
      sections: [
        {
          sectionId: "hero",
          order: 0,
          ...
          items: [
            {
              ...
              description:
                "Access to highly skilled IT professionals. Flexible, scalable solutions for all project sizes.",
            ...
            },
            {
              ...
              description:
                "Transform ideas into reality with our expert Software Development Services.",
            ...
            },
            {
              ...
              description:
                "Data scraping, AI-ML Engineering and reliable, scalable platforms.",
    ...
    },
    {
      ...
      isPublished: true,
      metaDescription:
        "Read about WeyBee success stories and client experiences",
      sections: [
        {
          sectionId: "featured",
          order: 0,
  ...
  for (const page of pages) {
    await PageContent.findOneAndUpdate({ pageSlug: page.pageSlug }, page, {
      upsert: true,
