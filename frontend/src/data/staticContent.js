// Static content data — hardcoded at build time for instant page loads.
// This is the same data that gets seeded into MongoDB.
// When a dev edits content via the CMS, it updates MongoDB.
// The build script (prebuild) fetches latest from MongoDB and overwrites this file.
// If the fetch fails (e.g. DB down), this fallback data is used.
